...
public class HinaModel extends GeoModel<HinaEntity> {

    @Override
    public Identifier getModelResource(HinaEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "geo/hina.geo.json");
    }

    @Override
    public Identifier getTextureResource(HinaEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "textures/entity/hina.png");
    }

    @Override
    public Identifier getAnimationResource(HinaEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "animations/hina.animation.json");
    }

    @Override
    public void setCustomAnimations(HinaEntity animatable, long instanceId, AnimationState<HinaEntity> animationState) {
