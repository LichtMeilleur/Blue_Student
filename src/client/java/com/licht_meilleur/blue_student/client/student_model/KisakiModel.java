...
public class KisakiModel extends GeoModel<KisakiEntity> {

    @Override
    public Identifier getModelResource(KisakiEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "geo/kisaki.geo.json");
    }

    @Override
    public Identifier getTextureResource(KisakiEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "textures/entity/kisaki.png");
    }

    @Override
    public Identifier getAnimationResource(KisakiEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "animations/kisaki.animation.json");
    }

    @Override
    public void setCustomAnimations(KisakiEntity animatable, long instanceId, AnimationState<KisakiEntity> animationState) {
